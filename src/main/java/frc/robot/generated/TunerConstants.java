...
public class TunerConstants {
    ...
    public class PoseidonTunerConstants {
        ...
        private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.21484375);
    ...
    public class ChazTunerConstants {
        ...
        // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
        private static final Slot0Configs driveGains = new Slot0Configs()
        // Generated by sysID using volage and adusting window size & velocity threshold.
        // .withKP(12.27).withKI(0).withKD(0.31588)
        // .withKS(0.18128).withKV(0.11909).withKA(0.0055502);
