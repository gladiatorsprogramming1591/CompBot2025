...
public class AutoScoreRightCommand extends Command {    
    ...
    public AutoScoreRightCommand(CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric reefAlign) {
